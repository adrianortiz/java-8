...
public class MainClass01FunctionalInterfacePredicate {
    ...
    public static void main(String[] args) {
        ...
        Predicate<User> filterAdrian = new FilterUserName("Adrian");
        Predicate<User> filterPerezOrAdrian = filterAdrian.or(new FilterUserLastName("Perez"));
        Predicate<User> filterIsRetired = filterPerezOrAdrian.or(User::isRetired);
